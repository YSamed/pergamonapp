...
export const mockCommunityGroupThreads: CommunityGroupThread[] = [
  {
    ...
    name: 'Disiplin Tayfa',
    previewSender: 'rudy',
    previewText: 'Bugün check-in ekranını atan var mı? herkes durum yazsın.',
    time: '09.10',
    unreadCount: 17,
    avatar: 'DT',
    avatarColor: '#0F766E',
  },
  {
    ...
    name: 'Kickoff Crew',
    previewSender: 'yusuf',
    previewText: 'Bu tempoyla gidersek haftayı rahat kapatırız.',
    time: '05.14',
    unreadCount: 2,
    avatar: 'KC',
    avatarColor: '#2563EB',
  },
  {
    ...
    previewText: 'Sabah rutini challenge puanları birazdan güncelleniyor.',
    time: '00.45',
    unreadCount: 23,
    avatar: 'GD',
    avatarColor: '#7C3AED',
  },
  {
    ...
    previewText: 'Akşam odak odasını 21.00 için sabitledim, gelin.',
    time: '00.43',
    unreadCount: 10,
    avatar: 'FN',
    avatarColor: '#EA580C',
  },
  {
    ...
    previewSender: 'sam',
    previewText: 'Yeni haftalık hedef çok iyi, bu kez tam çekeceğiz.',
    time: '00.20',
    unreadCount: 4,
    avatar: 'HE',
    avatarColor: '#BE123C',
  },
  {
    ...
    previewSender: 'surya',
    previewText: 'Yarın sabah herkes streak screenshot paylaşsın.',
    time: '00.32',
    unreadCount: 8,
    avatar: 'MH',
    avatarColor: '#166534',
